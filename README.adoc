...
| 1    | link:src\main\java\iut\sae\algo\Efficacite.java[Efficace java]| Java     | Efficacité
| 2    | link:src\main\java\iut\sae\algo\Simplicite.java[Simple java]    | Java     | Simplicité
| 3  | link:src\main\java\iut\sae\algo\Sobriete.java[Sobriété java]                                                   | Java      | Sobriété      
|==========================================================================
...
. Utilisez Codacy pour obtenir la qualité de l'algorithme
